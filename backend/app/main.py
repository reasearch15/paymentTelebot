...
from app.api.player_ledger import router as player_ledger_router
from app.api.providers import router as providers_router
from app.api.settlements import router as settlements_router
from app.api.telegram import router as telegram_router
from app.api.bot_ledger import router as bot_ledger_router
from app.api.telegram_deliveries import router as telegram_deliveries_router
...
app.include_router(telegram_deliveries_router)
app.include_router(bot_ledger_router)
